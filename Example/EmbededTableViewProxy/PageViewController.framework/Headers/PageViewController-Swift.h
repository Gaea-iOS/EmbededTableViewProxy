...
SWIFT_CLASS("_TtC18PageViewController18PageViewController")
@interface PageViewController : UIPageViewController
@property (nonatomic, readonly, strong) UIViewController * _Nullable currentController;
@property (nonatomic, readonly) NSInteger currentPageIndex;
@property (nonatomic, copy) void (^ _Nullable didScrollToIndex)(NSInteger);
...
- (void)viewDidLoad;
- (void)scrollToIndexWithIndex:(NSInteger)index animated:(BOOL)animated;
...
@interface PageViewController (SWIFT_EXTENSION(PageViewController)) <UIPageViewControllerDelegate>
...
@interface PageViewController (SWIFT_EXTENSION(PageViewController)) <UIPageViewControllerDataSource>
